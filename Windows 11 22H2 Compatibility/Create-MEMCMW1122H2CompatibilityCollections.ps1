...
$Collections = [ordered]@{
    ...
    "Windows 11 $W11Version Blocked: Safeguard Hold Id 40667045" = "select SMS_R_SYSTEM.ResourceID,SMS_R_SYSTEM.ResourceType,SMS_R_SYSTEM.Name,SMS_R_SYSTEM.SMSUniqueIdentifier,SMS_R_SYSTEM.ResourceDomainORWorkgroup,SMS_R_SYSTEM.Client from SMS_R_System inner join SMS_G_System_NITwentyTwoHTwo on SMS_G_System_NITwentyTwoHTwo.ResourceID = SMS_R_System.ResourceId where SMS_G_System_NITwentyTwoHTwo.GatedBlockId like ""%40667045%"""
    "Windows 11 $W11Version Blocked: Safeguard Hold Id 41291788" = "select SMS_R_SYSTEM.ResourceID,SMS_R_SYSTEM.ResourceType,SMS_R_SYSTEM.Name,SMS_R_SYSTEM.SMSUniqueIdentifier,SMS_R_SYSTEM.ResourceDomainORWorkgroup,SMS_R_SYSTEM.Client from SMS_R_System inner join SMS_G_System_NITwentyTwoHTwo on SMS_G_System_NITwentyTwoHTwo.ResourceID = SMS_R_System.ResourceId where SMS_G_System_NITwentyTwoHTwo.GatedBlockId like ""%41291788%"""
    "Windows 11 $W11Version Blocked: Safeguard Hold Id 41332279" = "select SMS_R_SYSTEM.ResourceID,SMS_R_SYSTEM.ResourceType,SMS_R_SYSTEM.Name,SMS_R_SYSTEM.SMSUniqueIdentifier,SMS_R_SYSTEM.ResourceDomainORWorkgroup,SMS_R_SYSTEM.Client from SMS_R_System inner join SMS_G_System_NITwentyTwoHTwo on SMS_G_System_NITwentyTwoHTwo.ResourceID = SMS_R_System.ResourceId where SMS_G_System_NITwentyTwoHTwo.GatedBlockId like ""%41332279%"""
    "Windows 11 $W11Version Blocked: Safeguard Hold Id 41584256" = "select SMS_R_SYSTEM.ResourceID,SMS_R_SYSTEM.ResourceType,SMS_R_SYSTEM.Name,SMS_R_SYSTEM.SMSUniqueIdentifier,SMS_R_SYSTEM.ResourceDomainORWorkgroup,SMS_R_SYSTEM.Client from SMS_R_System inner join SMS_G_System_NITwentyTwoHTwo on SMS_G_System_NITwentyTwoHTwo.ResourceID = SMS_R_System.ResourceId where SMS_G_System_NITwentyTwoHTwo.GatedBlockId like ""%41584256%"""
